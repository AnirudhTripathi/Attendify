...
public class Year_Adapter extends RecyclerView.Adapter<Year_Adapter.YearViewHolder> {

    Context context;
    String []list;

    public Year_Adapter(Context context, String[] list) {
    ...
    @Override
    public void onBindViewHolder(@NonNull YearViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.deptName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                data.put("Year",list[position]);
                Intent intent = new Intent(context.getApplicationContext(),Division_Activity.class);
